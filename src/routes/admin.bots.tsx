      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-heading font-bold text-foreground">{"'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            root@server1:/opt/apps/portal# cd /opt/apps/portal\r\ngit pull\r\nsystemctl restart bot-runner\r\nremote: Enumerating objects: 48, done.\r\nremote: Counting objects: 100% (48/48), done.\r\nremote: Compressing objects: 100% (16/16), done.\r\nremote: Total 40 (delta 39), reused 25 (delta 24), pack-reused 0 (from 0)\r\nUnpacking objects: 100% (40/40), 6.32 KiB | 323.00 KiB/s, done.\r\nFrom https://github.com/DianaKnodel1/zip-it-up\r\n   5b39c0b..64bca83  main       -> origin/main\r\nUpdating 5b39c0b..64bca83\r\nFast-forward\r\n bot-runner/server.ts              | 2 +-\r\n src/routes/admin.appointments.tsx | 2 +-\r\n src/routes/admin.bewerbungen.tsx  | 2 +-\r\n src/routes/admin.bots.tsx         | 2 +-\r\n 4 files changed, 4 insertions(+), 4 deletions(-)\r\nroot@server1:/opt/apps/portal# journalctl -u bot-runner -n 50 --no-pager\r\nAug 20 15:48:58 server1.com systemd[1]: Started bot-runner.service - Portal Bot Runner.\r\nAug 20 17:43:41 server1.com systemd[1]: Stopping bot-runner.service - Portal Bot Runner...\r\nAug 20 17:43:41 server1.com systemd[1]: bot-runner.service: Deactivated successfully.\r\nAug 20 17:43:41 server1.com systemd[1]: Stopped bot-runner.service - Portal Bot Runner.\r\nAug 20 17:43:41 server1.com systemd[1]: bot-runner.service: Consumed 1h 54min 42.676s CPU time.\r\nAug 20 17:43:41 server1.com systemd[1]: Started bot-runner.service - Portal Bot Runner.\r\nAug 20 18:17:44 server1.com systemd[1]: Stopping bot-runner.service - Portal Bot Runner...\r\nAug 20 18:17:44 server1.com systemd[1]: bot-runner.service: Deactivated successfully.\r\nAug 20 18:17:44 server1.com systemd[1]: Stopped bot-runner.service - Portal Bot Runner.\r\nAug 20 18:17:44 server1.com systemd[1]: bot-runner.service: Consumed 34min 2.843s CPU time.\r\nAug 20 18:17:44 server1.com systemd[1]: Started bot-runner.service - Portal Bot Runner.\r\nroot@server1:/opt/apps/portal#"}</h1>
